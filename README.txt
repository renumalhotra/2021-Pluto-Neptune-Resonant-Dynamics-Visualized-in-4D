...
- 3body.py : this python script is used to integrate (with the orbit integrator, REBOUND) the 3 body problem of the Sun, Neptune and Pluto, save the cartesian coordinates (both rotated and non-rotated) at intervals of 5 years to a text file
